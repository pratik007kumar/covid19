...
export default {
    ...
    computed: {
        ...mapGetters('DoctorsSingle', ['item', 'loading']),
    },
    created() {
    ...
    methods: {
        ...mapActions('DoctorsSingle', ['fetchData', 'updateData', 'resetState', 'setFirst_name', 'setLast_name', 'setEmail', 'setPhone', 'setAddress', 'setState', 'setPin']),
        updateFirst_name(e) {
