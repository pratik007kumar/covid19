...
import DatatableActions from "../../dtmodules/DatatableActionsPrescription";
...
export default {
  ...
  methods: {
    ...mapActions("PatientsIndex", ["fetchData", "setQuery", "resetState"])
  }
};
</script>
