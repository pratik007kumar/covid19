...
const routes = [
    ...
    { path: "/quiz", component: QuizHome, name: "quiz.home" },
    {
        path: "/quiz/covid-self-assessment",
        component: QuizCovidSelfAssessment,
        name: "quiz.covidselfassessment",
    },
    {
